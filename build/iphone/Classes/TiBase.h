...
// in simulator we redefine to format for Chapter05_Tigram Developer console
...
{\
	NSString * exceptionName = [@"org.chapter05_tigram." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chapter05_tigram";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIChapter05_TigramNativeItemNone = -1, 
	UIChapter05_TigramNativeItemSpinner = -2,
	UIChapter05_TigramNativeItemProgressBar = -3,
	
	UIChapter05_TigramNativeItemSlider = -4,
	UIChapter05_TigramNativeItemSwitch = -5,
	UIChapter05_TigramNativeItemMultiButton = -6,
	UIChapter05_TigramNativeItemSegmented = -7,
	
	UIChapter05_TigramNativeItemTextView = -8,
	UIChapter05_TigramNativeItemTextField = -9,
	UIChapter05_TigramNativeItemSearchBar = -10,
	
	UIChapter05_TigramNativeItemPicker = -11,
	UIChapter05_TigramNativeItemDatePicker = -12,
	
	UIChapter05_TigramNativeItemInfoLight = -13,
	UIChapter05_TigramNativeItemInfoDark = -14,
	
	UIChapter05_TigramNativeItemDisclosure = -15,
	
	UIChapter05_TigramNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Chapter05_Tigram instances of
