...
//Rare exceptions to indicate a bug in the _chapter05_tigram code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Chapter05_Tigram proxies.
 */
