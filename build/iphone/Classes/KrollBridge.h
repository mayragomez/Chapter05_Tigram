...
@interface Chapter05_TigramObject : KrollCoverageObject {
#else
@interface Chapter05_TigramObject : KrollObject {
#endif
@private
...
extern NSString * Chapter05_Tigram$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Chapter05_TigramObject *_chapter05_tigram;
    KrollObject* console;
	BOOL shutdown;
