...
/**
 The base class for all Chapter05_Tigram modules
 */
...
/**
 Chapter05_Tigram Platform calls this method on startup.
 */
-(void)startup;

/**
 Chapter05_Tigram Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Chapter05_Tigram Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Chapter05_Tigram Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Chapter05_Tigram Platform calls this method on resume.
 @param sender The sender of the event.
 */
