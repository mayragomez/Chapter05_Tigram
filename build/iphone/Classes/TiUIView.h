...
/**
 Base class for all Chapter05_Tigram views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Chapter05_Tigram view hierarchy (such as wrapped iOS UIViews) was touched.
