...
//@interface Chapter05_TigramObject : NSObject
//@end

@interface Chapter05_TigramObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Chapter05_TigramObject class]])
		{
			for (NSString *key in [[(Chapter05_TigramObject*)o modules] allKeys])
			{
